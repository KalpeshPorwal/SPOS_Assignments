...
//		String previ = "";
		...
		br = new BufferedReader(new FileReader("input3.asm"));
		BufferedWriter bw=new BufferedWriter(new FileWriter("IC3.txt"));
		INSTtable lookup=new INSTtable();
		while((line=br.readLine())!=null)
		{
			
			String parts[]=line.split("\\s+");  /* "\\s+" is used to match multiple
...
//				previ="START";
			...
			else if(parts[1].equals("ORIGIN"))
			{
				...
				{
					code="(AD,03)\t(C,"+Integer.parseInt(parts[2]+")");
				} // +
				bw.write(code+"\n");
			}
